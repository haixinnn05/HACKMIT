...
for (const file of all) {
  ...
  if (/\b(sk-[A-Za-z0-9_-]{20,}|sk-ant-[A-Za-z0-9_-]{20,}|AKIA[0-9A-Z]{16}|LLM[|_]\d{8,}[|_][A-Za-z0-9]{16,})\b/.test(text)) leaks.push(`${file} contains something shaped like an API key`);
}
