...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-5">
      <header className="relative -mx-5 -mt-5 overflow-hidden bg-lavender px-5 pb-16 pt-4">
        <Hills />
        <div className="relative flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            {note ? (
              <p className="mt-3 inline-block max-w-[14rem] rounded-[14px] rounded-bl-[4px] bg-surface/85 px-3 py-2 text-[12px] leading-snug text-ink shadow-[0_2px_8px_rgba(14,13,99,0.06)]">
                &ldquo;{note}&rdquo;
              </p>
            ) : null}
          </div>
          <div className="flex flex-col items-end gap-2">
            <Link href="/inbox" className="relative -mr-1.5 grid size-11 place-items-center rounded-full text-ink hover:bg-ink/5">
              <Bell size={22} />
            ...
            <Avatar name={participant.displayName} size="size-[4.5rem] text-xl" />
          </div>
        </div>
      </header>
